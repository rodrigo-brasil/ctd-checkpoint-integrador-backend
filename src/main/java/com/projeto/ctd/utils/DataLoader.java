...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        productRepository.save(new Product(null,1500.d,"Xiaomi Pocophone Poco X3 Pro Dual SIM 256 GB metal bronze 8 GB RAM","128gb","https://drive.google.com/uc?export=view&id=1-m5VSJbHYAPtDZXEtpESTbVBq5wcSYq_",smartphone));
        productRepository.save(new Product(null,2345.d,"Iphone 7","128gb","https://drive.google.com/uc?export=view&id=1-u6u2lOU4YLztB_RF7qYTTEQDyXvv6NZ",smartphone));
        productRepository.save(new Product(null,1300.d,"Samsung A32","64gb","https://drive.google.com/uc?export=view&id=1-nynbxyiQka7wjBafDPMRaSqHOf8YHrt",smartphone));
        productRepository.save(new Product(null,3200.d,"LG k62","128gb","https://drive.google.com/uc?export=view&id=1-sqhfrYV4_zXLsF8wSo2D3lQV_fYGKJ6",smartphone));
        productRepository.save(new Product(null,3100.d,"Smartphone Motorola E7","512gb","https://drive.google.com/uc?export=view&id=1-nUeEySFXrStgC51dG6DUEvH5YfNWRZI",smartphone));

        //Conectividade
        productRepository.save(new Product(null,448.d,"iCLAMPER Pocket 3 Pinos - 10A Preto","Plugue/tomada no padrão brasileiro três pinos( 2p + t)Fonte de alimentação: ac","https://drive.google.com/uc?export=view&id=1-GzxHyuOueUNdsYUxERUFbAbEKxWgq1Q",conectividade));
        productRepository.save(new Product(null,49.d,"TPlink-Repetidor","Wi-Fi Dual band AC1750 - Simultâneamente 450Mbps em 2.4GHz + 1300Mbps em 5GHz","https://drive.google.com/uc?export=view&id=1-5QVK4UOKHgEx9kGQIYig55GSlCExmu8",conectividade));
        productRepository.save(new Product(null,1000.d,"Google Chromecast 3","Fácil de configurar: plugue o Chromecast atrás de sua TV, conecte-se no Wi-Fi e comece a transmitir.","https://drive.google.com/uc?export=view&id=1-B6cDnpSlFXlU3hhXYIX4OZIHYmrSjZw",conectividade));
        productRepository.save(new Product(null,50.d,"Smart Lâmpada Wi-Fi Positivo Casa Inteligente","Compatível com Alexa e Google Assistente – você não precisa mais se levantar para acender/apagar as luzes dos ambientes","https://drive.google.com/uc?export=view&id=1-5Rz93zMjW_2XxhWekDeAMwgpchsrm-I",conectividade));
        productRepository.save(new Product(null,22.8d,"Adaptador USB Bluetooth 4.0 CSR Dongle","Conectividade: Bluetooth 4.0, Tecnologia Plug & Play, Alcance: 20 m ","https://drive.google.com/uc?export=view&id=1-0BDL9CyjmhLi012Sf9tasBHIl4eanOe",conectividade));

        //Áudio
        productRepository.save(new Product(null,99.d,"Headphone Philips Wireless BT Preto TAH1205BK/00","15 horas de reprodução e carregamento rápido,Som nítido e claro","https://drive.google.com/uc?export=view&id=1-c_gvM7UHi0Csnxd7sF5jSh6411Eodvr",audio));
        productRepository.save(new Product(null,154.d,"Caixa de Som Bluetooth JBL Boombox 2 80W Preta - JBLBOOMBOX2BLK","O JBL Boombox 2 vem com graves monstruosos, design arrojado e incrível tempo de reprodução de 24 horas.","https://drive.google.com/uc?export=view&id=1-en1bVkfuv2FY37wjET7DiLquE_BxxM0",audio));
        productRepository.save(new Product(null,270.d,"Caixa de Som Bluetooth Anker SC Icon Mini, Laranja","A Icon Mini conta com bluetooth 4.2 que garante a transmissão em uma distância de até 20m","https://drive.google.com/uc?export=view&id=1-lBZSajDdF2E3q1HxsMzOaQwWxqD2FVl",audio));
        productRepository.save(new Product(null,300.d,"Adaptador Receptor Áudio Bluetooth P2 Som Carro","Conecte seu audio muito mais fácil com esse adaptador","https://drive.google.com/uc?export=view&id=1-ZsOTnPFWhGe4F_91zeuwvQ2Vw0tGp0i",audio));
        productRepository.save(new Product(null,550.d,"Aparelho De Som Carro Automotivo Bluetooth Pendrive Sd Rádio","Som automotivo compatível adaptável","https://drive.google.com/uc?export=view&id=1-VRTpgF3fiCMgCxWlrKez49qY1vlID-6",audio));

        //Periféricos
        productRepository.save(new Product(null,45.d,"Mouse Gamer 3200dpi Led Com Fio 125hz 6 Botões Tedge","Gamers casuais e profissionais sabem que um mouse preciso e confiável pode fazer a diferença no jogo","https://drive.google.com/uc?export=view&id=1-TTiCiM-EohAZcZIedbKsck-YEyrnjek",perifericos));
        productRepository.save(new Product(null,78.d,"Teclado Mecânico Gamer Rainbow Iluminação Led Usb Tedge","Somos Tedge, uma marca do Mercado Livre. Criamos soluções de alta tecnologia, com design inovador e excelente qualidade, para proporcionar aos nossos clientes a melhor experiência, todos os dias!","https://drive.google.com/uc?export=view&id=1-T-11-YLABXI4OyrMOoJaNxEJ4PZbF31",perifericos));
        productRepository.save(new Product(null,145.d,"Full Hd 1080p Webcam Microfone Visão Computador Câmera","Vídeo HD: vídeo Full HD de 1080p, foco automático e correção avançada de luz para conversas nítidas e precisas.","https://drive.google.com/uc?export=view&id=1-RvH8jwOfIqluUB7T2VxJThGICsI3H3h",perifericos));
        productRepository.save(new Product(null,123.d,"Caixa De Som Pc Notebook Subwoofer Usb Soundbar","Conheça agora a nova tecnologia da Knup criada para facilitar e ajudar o seu dia a dia.","https://drive.google.com/uc?export=view&id=1-JkY94iGTa90uybA6WetUlj21FbnWA3C",perifericos));
        productRepository.save(new Product(null,450.d,"Mouse sem fio Logitech  Pebble M350 cinza-azulado","Resolução de 1000dpi.Criado para levar a qualquer lugar.Controle inteligente e fácil navegação.","https://drive.google.com/uc?export=view&id=1-ICZWa19E2HQIXiR4O_CBCbbT_hWOrGc",perifericos));
    }
}
