...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        productRepository.save(new Product(null,145.d,"Full Hd 1080p Webcam Microfone Visão Computador Câmera","Vídeo HD: vídeo Full HD de 1080p, foco automático e correção avançada de luz para conversas nítidas e precisas.","https://drive.google.com/file/d/1-RvH8jwOfIqluUB7T2VxJThGICsI3H3h/view?usp=sharing",perifericos));
        productRepository.save(new Product(null,123.d,"Caixa De Som Pc Notebook Subwoofer Usb Soundbar","Conheça agora a nova tecnologia da Knup criada para facilitar e ajudar o seu dia a dia.","https://drive.google.com/file/d/1-JkY94iGTa90uybA6WetUlj21FbnWA3C/view?usp=sharing",perifericos));
